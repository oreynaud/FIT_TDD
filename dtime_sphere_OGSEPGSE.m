% Calculate signal attenuation by cylindrical restriction & OGSE

function [signal_ogse,signal_pgse]=dtime_sphere_OGSEPGSE(p, omegalist, graddur, glut, Deltalist, deltalist)

% find roots of the bessel function
...
% new variables according to Xu (2009, quantitative measurements of tissue 
% microstructure using temporal diffusion spetcroscopy)
...
for i=1:dtno
   ...
   % =================================================================== %
   % Murday & Cotts (1968) - PGSE & spheres
   tauM=Deltalist(i);
...
signal_ogse=f*exp(-atten_sphere)+(1-f)*exp(-b.*Dfx);
% ====================================================================== %